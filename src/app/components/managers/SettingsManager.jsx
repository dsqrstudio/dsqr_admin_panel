  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-slate-600 mt-2">Manage your admin account security</p>
      </div>
      ...
      <div className="bg-gradient-to-br from-slate-50 to-gray-50 rounded-xl shadow-md border-2 border-slate-200 p-8">
        ...
        <div className="mt-6 flex justify-end">
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#cff000] to-[#b8dc00] text-slate-900 rounded-lg font-semibold hover:from-[#b8dc00] hover:to-[#a0c800] transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50"
          >
