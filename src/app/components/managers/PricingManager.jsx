                ...
                <div key={lvl} className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className={`w-full rounded border px-2 py-1 ${isInvalidKey(cat, lvl, "base", currency) ? "border-red-400" : ""}`}
                    />
                  </div>
                  ...
                  {prices[cat][lvl].fast && (
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        className={`w-full rounded border px-2 py-1 ${isInvalidKey(cat, lvl, "fast", currency) ? "border-red-400" : ""}`}
                      />
                    </div>
                  )}
                </div>
