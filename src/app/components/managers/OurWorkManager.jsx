...
export default function OurWorkManager({ activeSub }) {
  ...
  function BeforeAfterVideoManager() {
    ...
    const handleDeleteBefore = (id) => setDeleteTarget({ type: 'before', id })
    ...
    return (
      <div className="rounded-xl border bg-white p-8 shadow-md">
        ...
        <ConfirmModal
          ...
          message={
            deleteTarget?.type === 'before'
              ? 'Are you sure you want to delete this before/after video pair? This cannot be undone.'
              : 'Are you sure you want to remove the after video?'
          }
          confirmText="Delete"
          cancelText="Cancel"
          variant="danger"
        ...
        <p className="text-base text-slate-600 mb-6">
          ...
          <br />
          <b>Step 2:</b> For each before video, use the 'Upload After Video'
              ...
              {(pair.before || pair.after) && (
                <div className="flex justify-end mb-2">
                  <button
                    ...
                    onClick={() =>
                      handleDeleteBefore(pair.before?._id || pair.after?._id)
                    }
                  >
                    Delete
                  </button>
                  ...
                  {pair.after ? (
                    ...
                    <div className="w-full flex flex-col items-center">
                      ...
                      <input
                        ...
                        className="w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-blue-200 file:text-slate-900 hover:file:bg-blue-300"
                        onChange={(e) =>
                          e.target.files &&
